...
const SUGGESTIONS = [
  ...
  "Suggest a 3-month learning plan",
...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "👋 Hey! I'm your **CareerPilot AI mentor**. Ask me anything about careers, skills, or learning paths!" },
  ]);
    ...
    <>
      {!open && (
        <Button
          ...
          className="fixed bottom-6 right-6 z-40 h-14 w-14 rounded-full bg-gradient-primary shadow-elegant animate-pulse-glow hover:scale-110 transition-transform"
          size="icon"
        >
